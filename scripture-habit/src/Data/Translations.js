export const translations = {
    en: {
        ...
        donate: {
            ...
            header: "Support",
            subHeader: "Donations to Scripture Habit will be used for future development, service operation, maintenance, and improvement.",
            suggestionTitle: "Suggested Amounts (Feel free to choose any amount):",
            suggestion1: "🥤 $1 (Drink) - A quick boost!",
            methodsHeader: "Donations can be made by the following:",
            onlineTitle: "Support via PayPal",
            onlineDesc: "Click the button below for PayPal.",
            stripeOneOffButton: "One-off Donation ($1)",
            stripeMonthlyButton: "Monthly Support ($1/mo)",
            stripeUnderReview: "Under Review / Available Soon",
    ...
    ja: {
        ...
        donate: {
            ...
            header: "支える",
            subHeader: "Scripture Habitに充てられた皆様からのご寄付は、今後の開発、サービスの運用、保守、改善にあてられます。",
            suggestionTitle: "寄付額の目安（金額は自由にご決定いただけます）：",
            suggestion1: "🥤 $1 (ドリンク代) - 手軽にサポート！",
            methodsHeader: "寄付は以下の方法で行えます：",
            onlineTitle: "PayPal で支援",
            onlineDesc: "PayPalの場合は下のボタンをクリックしてください。",
            stripeOneOffButton: "一回のみ寄付する ($1)",
            stripeMonthlyButton: "毎月支援する ($1/月)",
            stripeUnderReview: "現在審査中につき、まもなく利用可能になります",
            button: "PayPalで寄付する",
        ...
        legalDisclosure: {
            ...
            onlinePaymentMethod: "PayPal、クレジットカード (Stripe)",
            ...
            personalDisclaimer: "※個人開発のため、所在地および電話番号については、開示を希望される場合にメールにてご請求いただければ遅滞なく提供いたします。"
        },
        newNote: {
            editTitle: "ノートを編集",
            newTitle: "ノート作成",
    ...
    pt: {
        ...
        donate: {
            ...
            header: "Apoio",
            subHeader: "As doações ao Scripture Habit serão aplicadas no desenvolvimento futuro, operação do serviço, manutenção e melhoria.",
            suggestionTitle: "Sugestões de Valor (Sinta-se livre para escolher):",
            suggestion1: "🥤 $1 (Bebida) - Um apoio rápido!",
            methodsHeader: "As doações podem ser feitas da seguinte forma:",
            onlineTitle: "Apoiar via PayPal",
            onlineDesc: "Clique no botão abaixo para PayPal.",
            stripeOneOffButton: "Doação Única\n(Qualquer valor)",
            stripeMonthlyButton: "Apoio Mensal\n(Valor fixo)",
            stripeUnderReview: "Em Análise / Disponível em Breve",
        ...
        legalDisclosure: {
            ...
            onlinePaymentMethod: "PayPal, Cartão de Crédito (Stripe)",
            ...
            personalDisclaimer: "*Como se trata de um desenvolvimento pessoal, as informações sobre endereço e número de telefone serão fornecidas sem atraso mediante solicitação por e-mail."
        },
        newNote: {
    ...
    zho: {
        ...
        donate: {
            ...
            header: "支持",
            subHeader: "捐贈給 Scripture Habit 的款項將用於未來的開發、服務運作、維護與改善。",
            suggestionTitle: "建議金額（您可以自由決定）：",
            suggestion1: "🥤 $1 (飲料) - 輕鬆的小支持！",
            methodsHeader: "可以通過以下方式進行捐款：",
            onlineTitle: "通過 PayPal 支持",
            onlineDesc: "請點擊下方按鈕使用 PayPal。",
            stripeOneOffButton: "一次性捐款\n(金額不限)",
            stripeMonthlyButton: "每月支持\n(固定金額)",
            stripeUnderReview: "審核中 / 即將推出",
            button: "通過 PayPal 捐款",
        ...
        legalDisclosure: {
            ...
            paymentTiming: "付款時間",
            paymentMethod: "付款方式",
            onlinePaymentMethod: "PayPal、信用卡 (Stripe)",
            deliveryTiming: "交付時間",
            cancellation: "取消/退款",
            environment: "運行環境",
            ...
            personalDisclaimer: "*由於是個人開發，關於地址和電話號碼的信息，若有要求，將在通過電子郵件請求後及時提供。"
        },
        newNote: {
            editTitle: "編輯筆記",
            newTitle: "新增筆記",
    ...
    es: {
        ...
        donate: {
            ...
            header: "Apoyo",
            subHeader: "Las donaciones a Scripture Habit se aplicarán al desarrollo futuro, operación del servicio, mantenimiento y mejora.",
            suggestionTitle: "Montos Sugeridos (Siéntete libre de elegir):",
            suggestion1: "🥤 $1 (Bebida) - ¡Un apoyo rápido!",
            methodsHeader: "Las donaciones se pueden hacer de la siguiente manera:",
            onlineTitle: "Apoyar vía PayPal",
            onlineDesc: "Haz clic en el botón de abajo para PayPal.",
            stripeOneOffButton: "Donación Única\n(Cualquier monto)",
            stripeMonthlyButton: "Donación Mensual\n(Monto fijo)",
            stripeUnderReview: "En Revisión / Disponible Pronto",
        ...
        legalDisclosure: {
            ...
            onlinePaymentMethod: "PayPal, Tarjeta de Crédito (Stripe)",
            ...
            personalDisclaimer: "*Debido a que es un desarrollo personal, la información sobre la dirección y el número de teléfono se proporcionará sin demora previa solicitud por correo electrónico."
        },
        newNote: {
    ...
    tl: {
        ...
        donate: {
            ...
            header: "Suporta",
            subHeader: "Ang mga donasyon sa Scripture Habit ay gagamitin para sa hinaharap na pag-unlad, operasyon ng serbisyo, maintenance, at pagpapabuti.",
            suggestionTitle: "Mungkahing Halaga (Malaya kang pumili):",
            suggestion1: "🥤 $1 (Inumin) - Isang mabilis na suporta!",
            methodsHeader: "Ang mga donasyon ay maaaring gawin sa pamamagitan ng sumusunod:",
            onlineTitle: "Suportahan gamit ang PayPal",
            onlineDesc: "I-click ang button sa ibaba para sa PayPal.",
            stripeOneOffButton: "Isahang Donasyon\n(Anumang halaga)",
            stripeMonthlyButton: "Buwanang Suporta\n(Fixed amount)",
            stripeUnderReview: "Under Review / Magagamit Na Malapit Na",
