export const translations = {
    en: {
        ...
        groupChat: {
            ...
            save: "Save",
            groupNameChanged: "Group name changed successfully",
            errorChangeGroupName: "Failed to change group name",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "A Promise to Walk Together",
            page3RuleContent1: "To keep the group active, we have a simple rule: <strong style='color: #E53E3E;'>Share your learning at least once every 3 days.</strong>",
            page3RuleContent2: "If you don't post for 3 days, you'll be automatically removed. This isn't a punishment, but a way to maintain the group's motivation.",
            page3RuleContent3: "Come back anytime you're ready! Small consistency leads to big changes.",
    ...
    ja: {
        ...
        groupChat: {
            ...
            messageEdited: "編集済み",
            changeGroupName: "グループ名を変更",
            enterNewGroupName: "新しいグループ名を入力",
            save: "保存",
            groupNameChanged: "グループ名が変更されました",
            errorChangeGroupName: "グループ名の変更に失敗しました",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "共に歩むための約束",
            page3RuleContent1: "グループの熱量を保つために、<strong style='color: #E53E3E;'>3日に1度は学びをシェアする</strong>という約束があります。",
            page3RuleContent2: "3日間投稿がないと自動的にお休み（退出）となりますが、これは罰則ではなく、お互いのモチベーションを守るための仕組みです。",
            page3RuleContent3: "また準備ができたら、いつでも戻ってきてください。小さな継続が、大きな変化を生みます！",
            page4Title: "ビジョン",
    ...
    pt: {
        ...
        groupChat: {
            ...
            changeGroupName: "Alterar Nome do Grupo",
            enterNewGroupName: "Digite o novo nome do grupo",
            save: "Salvar",
            groupNameChanged: "Nome do grupo alterado com sucesso",
            errorChangeGroupName: "Falha ao alterar o nome do grupo",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "Uma Promessa de Caminhar Juntos",
            page3RuleContent1: "Para manter o grupo ativo, temos uma regra simples: <strong style='color: #E53E3E;'>Compartilhe seu aprendizado pelo menos uma vez a cada 3 dias.</strong>",
            page3RuleContent2: "Se você não postar por 3 dias, será removido automaticamente. Isso não é uma punição, mas uma forma de manter a motivação do grupo.",
            page3RuleContent3: "Volte quando estiver pronto! A pequena constância leva a grandes mudanças.",
    ...
    zho: {
        ...
        groupChat: {
            ...
            messageEdited: "已編輯",
            changeGroupName: "更改群組名稱",
            enterNewGroupName: "輸入新群組名稱",
            save: "儲存",
            groupNameChanged: "群組名稱已成功更改",
            errorChangeGroupName: "更改群組名稱失敗",
            changeNickname: "更改暱稱",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "共同前行的承諾",
            page3RuleContent1: "為了保持群組活躍，我們有一個簡單的規則：<strong style='color: #E53E3E;'>每 3 天至少分享一次您的學習心得。</strong>",
            page3RuleContent2: "如果您 3 天未發文，將會被自動移除。這不是懲罰，而是為了維持群組動力的機制。",
            page3RuleContent3: "準備好時隨時回來！小小的堅持會帶來巨大的改變。",
            page4Title: "我們的願景",
    ...
    es: {
        ...
        groupChat: {
            ...
            messageEdited: "editado",
            changeGroupName: "Cambiar nombre del grupo",
            enterNewGroupName: "Ingresa el nuevo nombre del grupo",
            save: "Guardar",
            groupNameChanged: "Nombre del grupo cambiado con éxito",
            errorChangeGroupName: "Error al cambiar el nombre del grupo",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "Una Promesa de Caminar Juntos",
            page3RuleContent1: "Para mantener el grupo activo, tenemos una regla simple: <strong style='color: #E53E3E;'>Comparte tu aprendizaje al menos una vez cada 3 días.</strong>",
            page3RuleContent2: "Si no publicas durante 3 días, serás eliminado automáticamente. Esto no es un castigo, sino una forma de mantener la motivación del grupo.",
            page3RuleContent3: "¡Vuelve cuando estés listo! La pequeña constancia conduce a grandes cambios.",
    ...
    vi: {
        ...
        groupChat: {
            ...
            enterNewGroupName: "Nhập tên nhóm mới",
            save: "Lưu",
            groupNameChanged: "Đổi tên nhóm thành công",
            errorChangeGroupName: "Đổi tên nhóm thất bại",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "Lời Hứa Cùng Nhau Bước Đi",
            page3RuleContent1: "Để giữ cho nhóm hoạt động, chúng tôi có một quy tắc đơn giản: <strong style='color: #E53E3E;'>Chia sẻ những gì bạn học được ít nhất 3 ngày một lần.</strong>",
            page3RuleContent2: "Nếu bạn không đăng bài trong 3 ngày, bạn sẽ tự động bị xóa. Đây không phải là hình phạt, mà là cách để duy trì động lực cho nhóm.",
            page3RuleContent3: "Hãy quay lại bất cứ khi nào bạn sẵn sàng! Sự kiên trì nhỏ dẫn đến những thay đổi lớn.",
    ...
    th: {
        ...
        groupChat: {
            ...
            changeGroupName: "เปลี่ยนชื่อกลุ่ม",
            enterNewGroupName: "ป้อนชื่อกลุ่มใหม่",
            save: "บันทึก",
            groupNameChanged: "เปลี่ยนชื่อกลุ่มสำเร็จ",
            errorChangeGroupName: "ล้มเหลวในการเปลี่ยนชื่อกลุ่ม",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "สัญญาที่จะก้าวเดินไปด้วยกัน",
            page3RuleContent1: "เพื่อให้กลุ่มมีความเคลื่อนไหว เรามีกฎง่ายๆ: <strong style='color: #E53E3E;'>แบ่งปันการเรียนรู้ของคุณอย่างน้อยหนึ่งครั้งทุก 3 วัน</strong>",
            page3RuleContent2: "หากคุณไม่โพสต์เป็นเวลา 3 วัน คุณจะถูกลบออกโดยอัตโนมัติ นี่ไม่ใช่การลงโทษ แต่เป็นวิธีรักษาแรงจูงใจของกลุ่ม",
            page3RuleContent3: "กลับมาได้ทุกเมื่อที่คุณพร้อม! ความสม่ำเสมอเล็กๆ นำไปสู่การเปลี่ยนแปลงที่ยิ่งใหญ่",
    ...
    ko: {
        ...
        groupChat: {
            ...
            enterNewGroupName: "새 그룹 이름 입력",
            save: "저장",
            groupNameChanged: "그룹 이름이 성공적으로 변경되었습니다",
            errorChangeGroupName: "그룹 이름 변경 실패",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "함께 걷기 위한 약속",
            page3RuleContent1: "그룹을 활발하게 유지하기 위해 간단한 규칙이 있습니다: <strong style='color: #E53E3E;'>최소 3일에 한 번은 배운 내용을 공유하세요.</strong>",
            page3RuleContent2: "3일 동안 게시하지 않으면 자동으로 삭제됩니다. 이것은 처벌이 아니라 그룹의 동기를 유지하기 위한 방법입니다.",
            page3RuleContent3: "준비되면 언제든지 돌아오세요! 작은 꾸준함이 큰 변화를 만듭니다.",
            page4Title: "우리의 비전",
    ...
    tl: {
        ...
        groupChat: {
            ...
            changeGroupName: "Baguhin ang Pangalan ng Grupo",
            enterNewGroupName: "Ilagay ang bagong pangalan ng grupo",
            save: "I-save",
            groupNameChanged: "Matagumpay na nabago ang pangalan ng grupo",
            errorChangeGroupName: "Nabigong baguhin ang pangalan ng grupo",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "Isang Pangakong Lumakad na Magkasama",
            page3RuleContent1: "Upang mapanatiling aktibo ang grupo, mayroon kaming simpleng panuntunan: <strong style='color: #E53E3E;'>Ibahagi ang iyong natutunan nang hindi bababa sa isang beses bawat 3 araw.</strong>",
            page3RuleContent2: "Kung hindi ka mag-post sa loob ng 3 araw, awtomatiko kang aalisin. Hindi ito parusa, kundi isang paraan upang mapanatili ang motibasyon ng grupo.",
            page3RuleContent3: "Bumalik anumang oras kapag handa ka na! Ang maliit na pagkakapare-pareho ay humahantong sa malalaking pagbabago.",
    ...
    sw: {
        ...
        groupChat: {
            ...
            changeGroupName: "Badilisha Jina la Kikundi",
            enterNewGroupName: "Ingiza jina jipya la kikundi",
            save: "Hifadhi",
            groupNameChanged: "Jina la kikundi limebadilishwa kikamilifu",
            errorChangeGroupName: "Imeshindwa kubadilisha jina la kikundi",
        ...
        welcomeStory: {
            ...
            page3RuleTitle: "Ahadi ya Kutembea Pamoja",
            page3RuleContent1: "Ili kuweka kikundi hai, tuna sheria rahisi: <strong style='color: #E53E3E;'>Shiriki ulichojifunza angalau mara moja kila siku 3.</strong>",
            page3RuleContent2: "Ikiwa hutachapisha kwa siku 3, utaondolewa kiotomatiki. Hii sio adhabu, lakini ni njia ya kudumisha motisha ya kikundi.",
            page3RuleContent3: "Rudi wakati wowote ukiwa tayari! Msimamo mdogo husababisha mabadiliko makubwa.",
